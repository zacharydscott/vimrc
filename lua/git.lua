...
nsk('n','<Leader>gP',':Git pull --all<CR>',opts)
nsk('n','<Leader>gu',':Git push<CR>',opts)
nsk('n','<Leader>ga',':Git status<CR>',opts)
...
nsk('n','<Leader>gc',':call GitCommit("")<Left><Left>',opts)
nsk('n','<Leader>go',':G checkout<Space>',opts)
